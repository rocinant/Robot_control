...
#define  TurnSpeedFactor2 4 //to control the moving speed when you know the turing speed, should be value between 1 and 2 2*TurnSpeedFactor2-TurnSpeedFactor1 should be >0
...
void SetMotors(int FirstSpeed, int SecondSpeed, bool heedSonar) {
  ...
  if (FirstSpeed>0&&SecondSpeed>0) {
    ...
    analogWrite(LEFT_MOTOR_PIN, constrain(map(SecondSpeed, 0, ReceivedMaxSpeed, 0, 255)+7, 0, 255));
